		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Space amenities management</h1>
				</div>
				<!-- END PAGE TITLE -->
			</div>
			<!-- END PAGE HEAD -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								<a href="{{ route('spaces.create') }}" class="btn btn-default btn-sm">
									<i class="fa fa-globe"></i>
									create new space amenities
								</a>
							</div>
							<div class="tools">
							</div>
						...
						<div class="portlet-body">
							...
							@foreach( $spaces as $k => $s )
	                            <tr>
									...
									<td>
										<a href="{{ route('spaces.edit', $s->id) }}" class="btn btn-sm btn-primary edit">
											<i class="fa fa-pencil"></i> Edit
										</a>
										<form style="display: -webkit-inline-box;" action="{{ route('spaces.destroy', $s->id) }}" id="delete_form" method="POST">
											{{ csrf_field() }}
											{{ method_field('DELETE') }}
