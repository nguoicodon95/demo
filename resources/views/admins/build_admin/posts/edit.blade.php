...
<div class="page-content">
	...
	<div class="page-head">
		...
		<div class="page-title">
			<h1>Posts <small>create new post</small></h1>
		</div>
		<!-- END PAGE TITLE -->
	</div>
	<!-- END PAGE HEAD -->
        ...
        <div class="col-md-12">
            <div class="portlet light form-fit">
                ...
                <div class="portlet-body form">
                    ...
                    <!-- BEGIN FORM-->
                    <!-- BEGIN FORM-->
                    <form action="{{ $post->exists ? route('posts.update', $post->id) : route('posts.store') }}" class="form-horizontal form-bordered" method="post">
                        {{ csrf_field() }}
                        {{ method_field($post->exists ? 'PUT' : 'POST') }}
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="category_id" class="form-control">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" {{ $post->exists && $category->id == $post->category_id ? 'selected' : '' }}>{{ $category->title }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description" class="form-control">{{ $post->description or '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="content" class="form-control contentMCE">{{ $post->content or '' }}</textarea>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="select-media-box">
                                        ...
                                        <a title="" class="show-add-media-popup">
                                            <img src="{{ ($post->exists && trim($post->image != '')) ? $post->image : '/admins/assets/img/no-image.png' }}" alt="Thumbnail" class="img-responsive">
                                        </a>
                                        <input type="hidden" name="image" value="{{ $post->image or '' }}" class="input-file">
